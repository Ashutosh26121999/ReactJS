...
[
   {
     ...
     "analytics": {
       "context": "seo-data-cf44ae8f-acb0-4aa8-8cbf-074886a7ecd3"
     },
     "cta": {
   ...
   },
   {
     "info": {
       "id": "622616",
       "name": "Domino's Pizza",
       "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/10/24/4515e407-41c9-4259-897a-07d8ebf918cf_622616.JPG",
       "locality": "3rd Sector",
       "areaName": "Rohini",
   ...
   },
   {
     "info": {
       "id": "254192",
       "name": "McDonald's",
       "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/10/22/145d4638-87e2-408e-88ee-808938b00da1_254192.JPG",
       "locality": "Sector 10",
       "areaName": "Rohini",
       "costForTwo": "₹400 for two",
       "cuisines": [
   ...
   },
   {
     "info": {
       "id": "10392",
       "name": "Subway",
       "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/10/25/ab24a2a2-1dca-4f2e-b030-9c21fa095972_10392.jpg",
       "locality": "Sector 3",
       "areaName": "Rohini M2K",
       "costForTwo": "₹350 for two",
       "cuisines": [
    ...
    return(
        <div className='header'>
            ...
            <div className='logo-container'>
               <img className='logo' src="https://img.freepik.com/premium-vector/food-ordering-app-logo-with-points-fork-shapes-center_666184-195.jpg?semt=ais_hybrid" alt="Logo" />
            </div>
            {/* Navigation Menu */}
...
const RestaurantCard=(props)=>{
   const {cloudinaryImageId,name,costForTwo,avgRatingString,deliveryTime,cuisines}=props.restaurant.info
    return(
        <div className='restaurant-card'>
            {/* Image */}
            <img className='res-logo' src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId} alt="Logo" />
            <div className='res-data-container'>
               ...
               {/* Delivery Time */}
               <h4 className='res-del-time'>Deliver in {deliveryTime} min</h4>
               {/* Cusines */}
